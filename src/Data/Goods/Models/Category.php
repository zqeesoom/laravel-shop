...
class Category extends Model
{
    ...
    public function test()
    {
        ...
        //解决批量修改不会触发观察者
       // return Category::where('id',7)->update(['name'=>'test']);
        ...
        return Category::where('id', 1)->first()->children->toArray();//获取一个
        return Category::where('id', 1)->first()->childrens->toArray();//获取多个
    }
}
