...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('vendor/zqeesoom/laravel-wap-shop/css/pre_foot.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('vendor/zqeesoom/laravel-wap-shop/css/pro-detail.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('vendor/zqeesoom/laravel-wap-shop/css/font-awesome.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('vendor/zqeesoom/laravel-wap-shop/css/showbox.css')}}">
    <link rel="stylesheet" href="../../static/css/layer.css" id="layuicss-skinlayercss">
    <script src="{{asset('vendor/zqeesoom/laravel-wap-shop/js/showbox.js')}}"></script>
    <script src="{{asset('vendor/zqeesoom/laravel-wap-shop/js/jquery.js')}}"></script>
    <script type="text/javascript" src="{{asset('vendor/zqeesoom/laravel-wap-shop/js/layer.js')}}"></script>
    <script src="{{asset('vendor/zqeesoom/laravel-wap-shop/js/load_task.js')}}" type="text/javascript"></script>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('vendor/zqeesoom/laravel-wap-shop/css/control_type.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('vendor/zqeesoom/laravel-wap-shop/css/goods_list.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('vendor/zqeesoom/laravel-wap-shop/css/group_buy.css')}}">
    <style type="text/css">
...
<div class="popup" style="position:fixed;top: 36%;left: 0px;width: 100%;height: 100%;margin-left:0px;display:none;">
    ...
    <div class="code">
        <div style="overflow: hidden;">
            <img src="{{asset('vendor/zqeesoom/laravel-wap-shop/picture/1500630330.jpg')}}"  style="max-width: 100%;margin-top: 10px;"/>
...
<script language="javascript" src="{{asset('vendor/zqeesoom/laravel-wap-shop/js/jweixin-1.0.0.js')}}"> </script>
...
<div class="com-content">
    ...
    <div style="width: 100%;background-color: #fff;padding: 10px 0px;">
        <script src="{{asset('vendor/zqeesoom/laravel-wap-shop/js/public_assembly.js')}}"></script>
        <style>
    ...
    <!-- 轮播图 -->
    <link rel="stylesheet" type="text/css" href="{{asset('vendor/zqeesoom/laravel-wap-shop/css/slick.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('vendor/zqeesoom/laravel-wap-shop/css/components.css')}}">
    <script src="{{asset('vendor/zqeesoom/laravel-wap-shop/js/slick.js')}}"></script>
    <div class="slick">
        <div style="display:block;text-align:center;width:100%;height:175px;line-height:175px;">
            <a href="#">
                <img src="{{asset('vendor/zqeesoom/laravel-wap-shop/picture/1497070640.png')}}" alt="" style="height:175px;max-width:100%/* ;height:auto; */display: inline-block !important;vertical-align: middle !important;">
            </a>
        </div>
    </div>
    ...
    <!-- 公告 -->
    <link rel="stylesheet" type="text/css" href="{{asset('vendor/zqeesoom/laravel-wap-shop/css/limarquee.css')}}">
    <script src="{{asset('vendor/zqeesoom/laravel-wap-shop/js/jquery.limarquee.js')}}"></script>
    <style>
        .hot {
            width: 100%;
            height: 40px;
    ...
    <div class="hot" style="position: relative; overflow: hidden;">
        <div class="notice-img">
            <a href="javascript:;"><img src="{{asset('vendor/zqeesoom/laravel-wap-shop/picture/ad.png')}}"></a>
        </div>
    ...
    <!-- 导航 -->
    <link rel="stylesheet" type="text/css" href="{{asset('vendor/zqeesoom/laravel-wap-shop/css/navi.css')}}'">
    <div class="navi">
        <div class="navi-item">
